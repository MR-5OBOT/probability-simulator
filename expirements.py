...
def calculate_and_plot():
    balance_history = probability_simulator(balanceEntry, riskEntry, rrEntry, nTrades_entry, result_label)
...
separator.grid(column=0, row=5, sticky="nsew", pady=5)

result_frame = ttk.LabelFrame(inputsLabel, text="Results")
result_frame.grid(column=0, row=6, sticky="nsew")
